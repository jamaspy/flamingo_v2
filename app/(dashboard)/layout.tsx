...
import { signOut } from "@/components/complex/forms/login-form/actions";
...
function UserMenu() {
  ...
  return (
    <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
      ...
      <DropdownMenuContent
        align="end"
        className="flex flex-col gap-1 font-light text-slate-800"
      >
    ...
    <header className="bg-transparent fixed top-0 left-0 right-0 z-50">
      <div className="px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <Link href="/" className="flex items-center">
          ...
          <span className="ml-2 text-xl font-light text-flamingo-primary">
            flamingo.tm
          </span>
        </Link>
